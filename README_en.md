...
1. **storageState concept** (Part 4) → Login state management
2. **Fixtures** (Part 6) → Provide auth state + expected data as a set
3. **Soft Assertions** (Part 5) → Verify multiple items at once
